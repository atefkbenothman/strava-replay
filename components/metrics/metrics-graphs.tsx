...
export default function MetricsGraphs({ activityStream, playing }: Props) {
  ...
  return (
    <div className="h-full w-full grid grid-cols-1 grid-rows-4 gap-2 overflow-scroll">
      <div>
        <div className="w-full h-full relative border-2 border-secondary p-3 rounded">
          <div className="flex gap-2 absolute top-0 left-0 m-2 flex items-center justify-center text-white font-medium text-xl">
            <p>Speed</p>
      ...
      <div>
        <div className="w-full h-full relative border-2 border-secondary p-3 rounded">
          <div className="absolute top-0 left-0 m-2 flex gap-2 items-center justify-center text-white font-medium text-xl">
            <p>Elevation</p>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6">
